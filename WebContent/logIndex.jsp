	...
	<c:choose>
		<c:when test="${loginID!=null}">
			<div id="wrapper2">
				...
				<div>
					<input type="button" value="게시판" id="board"> <input
						type="button" value="마이페이지" id="myPage"> <input
						type="button" value="회원탈퇴" id="signOut"> <input
						type="button" value="로그아웃" id="logOut">
				</div>
			</div>
			<script>
				$(function() {
					...
					$("#board").on("click", function() {//게시판
						location.href = "goBoard.board";
					});
		...
		<c:otherwise>
			<div id="wrapper">
				<form action="login.me">
					...
					<div>
						<input id="loginBtn" type="submit" value="로그인"> <input
							id="signBtn" type="button" value="회원가입">
					</div>
				</form>
			</div>
